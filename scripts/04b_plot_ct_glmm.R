...
plot_ct_glmm <-
  ...
  geom_signif(
    ...
    xmax = 2,
    size = 0.075,
    annotation = paste0("p=", format(round(summary(mod_ct_yes)$coefficients[2, "Pr(>|z|)"], 3), nsmall = 3)), 
    tip_length = c(0.075, 0.24),
    color = "black",
    vjust = -0.25,
    textsize = 4
  ...
  geom_signif(
    ...
    xmax = 3,
    size = 0.075,
    annotation = paste0("p=", format(round(summary(mod_ct_yes)$coefficients[3, "Pr(>|z|)"], 3), nsmall = 3)),
    tip_length = c(0.385, 0.13),
    color = "black",
    vjust = -0.25,
    textsize = 4
