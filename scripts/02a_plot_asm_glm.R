...
fit %>%
  ...
  geom_signif(
    ...
    xmax = 2,
    size = 0.075,
    annotation = paste0("p=", format(round(summary(mod_asm_no)$coefficients[2, "Pr(>|z|)"], 3), nsmall = 3)), 
    tip_length = c(0.3, 0.025),
    color = "black",
    vjust = -0.25,
    textsize = 4
  ...
  geom_signif(
    ...
    xmax = 3,
    size = 0.075,
    annotation = paste0("p=", format(round(summary(mod_asm_no)$coefficients[3, "Pr(>|z|)"], 3), nsmall = 3)),
    tip_length = c(0.6, 0.25),
    color = "black",
    vjust = -0.25,
    textsize = 4
