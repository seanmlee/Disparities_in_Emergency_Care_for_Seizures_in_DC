...
fit %>%
  ...
  geom_signif(
    ...
    xmax = 2,
    size = 0.075,
    annotation = paste0("p=", format(round(summary(mod_duration_ed_yes)$coefficients[2, "Pr(>|t|)"], digits = 3), nsmall = 3)), 
    tip_length = c(0.01, 0.12),
    color = "black",
    vjust = -0.25,
    textsize = 4
  ...
  geom_signif(
    ...
    xmax = 3,
    size = 0.075,
    annotation = paste0("p=", format(round(summary(mod_duration_ed_yes)$coefficients[3, "Pr(>|t|)"], digits = 3), nsmall = 3)), 
    tip_length = c(0.25, 0.07),
    color = "black",
    vjust = -0.25,
    textsize = 4
